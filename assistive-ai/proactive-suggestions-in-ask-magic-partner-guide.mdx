...
### Related Articles - [IT Glue + Ask Magic Partner Guide](/integrations/it-glue-ask-magic) - [Manager Guide -Getting started with Client Intelligence](/ai-agents/getting-started-with-knowledge) - [Magic Recap Template Library](/assistive-ai/magic-recap-template-library)
