...
description: "Get started with Automagically — the AI IT automation agent that generates runbooks from plain English and runs them against client environments in one click."
---
