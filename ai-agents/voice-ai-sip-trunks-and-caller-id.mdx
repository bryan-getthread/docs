...
| **Authentication failed** | Reached the server but credentials were rejected. | Confirm Thread's egress IPs are allowlisted and that the username and password match your PBX. |
