---
title: "Track Magic Agent Activity with a Workflow"
description: "Create a dedicated PSA status for Magic Agent tickets and use Thread Inbox views to monitor AI-triaged work, dispatch-ready tickets, and overall agent activity."
---
