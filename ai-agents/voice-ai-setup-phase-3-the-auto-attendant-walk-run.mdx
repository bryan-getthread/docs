...
<Warning>
  Critical Loop Warning When using this mode, you must ensure the Thread Agent transfers calls to a specific Ring Group Extension or Technician Queue, NOT back to the Main Phone Number. Forwarding back to the Main Number will cause an infinite loop.
</Warning>
