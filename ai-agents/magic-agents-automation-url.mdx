---
title: "Trigger Automations with the Magic Agents Automation URL"
description: "Send Magic Agent intent data to any URL via POST to trigger automations in Power Automate, Azure Functions, Rewst, Zapier, or Make for onboarding and more."
---
