---
title: "Slack Permissions Guide"
description: "Thread’s Slack app uses a defined set of permissions that allow it to read messages, identify users, react to events, and send updates inside Slack. Permissions are grouped according to Slack’s nativ…"
---
