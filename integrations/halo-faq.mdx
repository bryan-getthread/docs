...
description: "Why are deleted tickets in HaloPSA still showing in the Thread Inbox? If deleted tickets from HaloPSA are still appearing in the Thread Inbox, you'll need to disable a specific setting in HaloPSA. Go…"
---
