---
title: "Set Up an Autotask Email Workflow for Thread Chats"
description: "Use an Autotask UDF and workflow rule to send closed-loop customer email notifications on every Thread chat reply while keeping chat-only replies quiet."
---
