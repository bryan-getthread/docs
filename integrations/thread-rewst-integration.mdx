---
title: "Trigger Rewst Workflows from Thread Magic Intents"
description: "Use the Thread Automations Crate to send Magic AI intent data, like employee onboarding fields, to Rewst workflows via secure shared-secret webhooks."
---
