---
title: "ConnectWise Manage API Permissions Reference"
description: "Reference for the ConnectWise Manage security role permissions Thread requires to sync companies, contacts, tickets, time entries, and attachments."
---
