---
title: "Flows: Automate Thread Routing and Actions in Inbox"
description: "Use Flows to automate Inbox actions with if-this-then-that logic. Build triggers, route threads to Teams or Slack, and apply nested filter groups."
---
