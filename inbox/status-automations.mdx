---
title: "Status Automations: Auto-Update Thread Statuses"
description: "Configure per-board Status Automations to update a thread's status on first reply, contact replies to closed threads, or TimePad resolution flag entries."
---
