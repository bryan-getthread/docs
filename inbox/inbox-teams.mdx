...
From the View's menu, select **Duplicate to Team…**, then select the Team. This will maintain your current view and duplicate it within the Team you selected. Feel free to delete the pre-existing view from the Views section.
...
Partially. Use the View's menu and select **Duplicate to Team…**, then select the destination Team. When you do this, the View is **duplicated** for the chosen Team, and the original View in the Views section remains.
