...
description: "Team Admin Role. Concept. The Team Admin is a middle-tier user role in Thread that sits between a standard Member and a full workspace Admin. While the role itself is assigned globally, a Team Admin'…"
---
