...
description: "Meet Super Magic, Thread's in-Inbox AI assistant that searches tickets, clients, and knowledge and takes confirmed write actions like updates and time logs."
---
...
It's **thread-aware**: open it while you're viewing a conversation and it already knows that thread's context — no need to explain what ticket you're on. On the full Super Magic page, the left **Magic** sidebar has **+ New Chat**, links to **Connectors** and **Skills**, and a **History** list of your past conversations — click any row to reopen it, or hover a row to delete it.

Your history is grouped by when each chat was last updated — **Today**, **Yesterday**, **Past 7 days**, and **Older than 7 days** — with empty groups hidden. Groups with more than five chats collapse behind a **See more** toggle you can expand and collapse.

To jump to a specific chat, type in the **Find a chat** box at the top of the sidebar. It filters by chat title as you type (with a short pause after you stop), and hides **+ New Chat**, **Connectors**, and **Skills** so only matching chats show. If nothing matches, you'll see **No chats to show...** Click the **X** in the field to clear your search and get the full list back.
