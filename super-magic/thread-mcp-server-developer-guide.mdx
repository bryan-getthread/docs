...
description: "Connect Claude Desktop, ChatGPT, Cursor, or any MCP client to Thread's service-desk API via OAuth 2.1 to search tickets, manage contacts, and run write actions."
---
