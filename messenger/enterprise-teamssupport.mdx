---
title: "Enterprise Teams Support: Shared M365 Tenants"
description: "Deploy the Thread Teams app once at the parent company for MSPs with multiple sub-companies sharing one Microsoft 365 tenant using parent-child mapping."
---
