...
description: "How Thread uses APIs and webhooks to keep ConnectWise, Autotask, and HaloPSA tickets, contacts, and statuses in sync with the Inbox in real time, two ways."
---
