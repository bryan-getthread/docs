...
- **Priority and status views:** Easily filter and sort your inbox by urgency, specific client, service board, or technician assignment.
...
- **After-hours and first-line support:** Acts as a reliable answering service when your human team is unavailable.
...
### Related Articles - [Getting started with Magic Analytics](/article/nfls9mdj50-getting-started-with-magic-analytics) - [FAQs](/article/7zwj4c5kx5-faqs) - [Pia Integration](/article/qr9jy2gsfe-pia-integration)
