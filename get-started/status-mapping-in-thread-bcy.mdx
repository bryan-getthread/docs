---
title: "Configure Status Mapping in Thread (duplicate)"
description: "The first and most important step in setting up status mapping is configuring a Status Group for 'Done'. This group is not retroactive, so it’s important to include all statuses that indicate closure…"
---
